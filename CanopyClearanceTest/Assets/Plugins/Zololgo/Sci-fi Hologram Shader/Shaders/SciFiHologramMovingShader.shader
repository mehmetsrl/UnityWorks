...
Shader "Zololgo/Sci-Fi Hologram Moving" 
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			v2f vert (appdata v)
			{
				...
				o.scanlines_uv = -.32f * _Scanlines_ST.xy + frac(_Time.x*_Scanlines_ST.zw);
				o.scan2_uv = o.scanlines_uv;
				#if SCAN2_ON
				//o.scan2_uv = flicker_uv * _Scan2_ST.xy + frac(_Time.x*_Scan2_ST.zw);
				o.scan2_uv = -.32f * _Scan2_ST.xy + frac(_Time.x*_Scan2_ST.zw);
				#endif
