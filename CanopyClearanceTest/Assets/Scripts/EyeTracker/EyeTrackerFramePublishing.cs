...
public class EyeTrackerFramePublishing : MonoBehaviour {
    ...
    void OnEnable()
    {
        Debug.Log("Enable on Frame Publishing");
        // Main
        if (PupilSettings.Instance.currentCamera == null)
        {
        ...
        Debug.Log(PupilSettings.Instance.currentCamera.name);
    }
    ...
    void CustomReceiveData(string topic, Dictionary<string, object> dictionary, byte[] thirdFrame = null)
    {
        ...
        Debug.Log("Getting InputData" + Environment.NewLine + "Topic:" + topic);
        if (thirdFrame == null)
        {
            Debug.Log("Third Frame is null");
            return;
        }
    ...
    {
        Transform parent = PupilSettings.Instance.currentCamera.transform;
        Shader shader = Shader.Find("Unlit/Texture");

        eyeTexture[eyeIndex] = new Texture2D(1000, 1000);
        ...
        Debug.Log("InitializeFramePublishing with Eye" + eyeIndex);
    }
    ...
    MeshRenderer InitializeEyeObject(int eyeIndex, Transform parent)
    {
         ...
         */
        string eyeName = "";
        float eyePositionX = 0f;
        if (eyeIndex == 0)
        {
            eyeName = "LeftEye";
            eyePositionX = -1.0367f;
        ...
        go.transform.localScale = new Vector3(0.206f, 0.2f, 0.2313f);
        go.transform.localPosition = new Vector3(eyePositionX, 0.0031f, 1.9999f);
